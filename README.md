...
Перед загрузкой ссылки на сертификат убедитесь, что в нем отображаются ваши полные фвамилия, имя и отчество (при наличии). Для этого необходимо заполнить профиль на платформе Нетологии.
